...
The current version in the repository is 1.0.8
...
## Изменения этого форума
- Исправление баланса там, где он может показаться душным по моему мнению.

например: не такой сильный прирост шока от урона - позволяет дольше держаться в сознании.

- Добавление новых механик или улучшения существующих 

- Добавление новых режимов

- Выявление каких-то багов и помощь оригинальному репозиторию
